...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, sample_size, sample_duration, shortcut_type='B', num_classes=400, last_fc=True):
        ...
        # orginal
        self.conv1 = nn.Conv3d(3, 8, kernel_size=7, stride=(1, 2, 2),
                               padding=(3, 3, 3), bias=False)

        # # replace with 3*3
        # self.conv1 = nn.Conv3d(3, 8, kernel_size=(3,7,7), stride=(1, 2, 2),
        ...
        self.layer2 = self._make_layer(block, 64, layers[1], shortcut_type, stride=(1,3,3))
        self.layer3 = self._make_layer(block, 128, layers[2], shortcut_type, stride=(1,3,3))
        self.layer4 = self._make_layer(block, 256, layers[3], shortcut_type, stride=(1,3,3))
        # last_duration = math.ceil(sample_duration / 16)
        # last_size = math.ceil(sample_size / 32)
        # self.fc = nn.Linear(512 * block.expansion, num_classes)
        self.avgpool = nn.AvgPool3d((1, 3, 3), stride=1)
